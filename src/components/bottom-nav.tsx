...
export function BottomNav() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-md items-center justify-around px-1 pt-1 pb-[max(env(safe-area-inset-bottom,0px),0.5rem)]">
        {tabs.map(({ href, label, icon: Icon }) => {
          ...
          return (
            <Link
              ...
              href={href}
              className={cn(
                "relative flex flex-col items-center justify-center gap-1 py-1.5 px-3 rounded-sm text-[11px] font-medium transition-all min-w-[64px] min-h-[44px]",
                active
